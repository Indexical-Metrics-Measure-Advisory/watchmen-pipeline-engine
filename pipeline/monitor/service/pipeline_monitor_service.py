...
from pipeline.utils.units_func import add_audit_columns, INSERT
from pipeline.topic.storage.topic_schema_storage import get_topic_by_name, save_topic
...
def sync_pipeline_monitor_data(pipeline_monitor: PipelineRunStatus):
    ...
    pipeline.index.trigger_pipeline(code,
