...
from pipeline.external.service.index import get_writer_func
from pipeline.external.storage import external_storage
    ...
    def write_to_external():
        ...
        if settings.EXTERNAL_WRITER_ON:
            ...
            if external_writer:
                ...
                asyncio.ensure_future(writer(action.eventCode, current_data, previous_data))
        else:
